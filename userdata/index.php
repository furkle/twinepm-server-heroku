...
if ($reqMethod === "GET") {
	require_once __DIR__ . "/../twinepm-credentials/get/userdata.php";
} else if ($reqMethod === "POST") {
	require_once __DIR__ . "/../twinepm-credentials/post/userdata.php";
} else if ($reqMethod === "DELETE") {
	require_once __DIR__ . "/../twinepm-credentials/delete/userdata.php";
